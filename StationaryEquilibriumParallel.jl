        ...
        elseif e_i==2
            ...
            elseif s_i==2
                ...
                for i1_i in 1:n_i
                    ...
                    push!(i,ind)
                    push!(j,ind1_e[i1_i])
                    push!(k,(1-δ)*pol_σ_U[i_i*n_a+a1_i,i1_i]*p(θ[ind1_e[i1_i]]))

                    push!(i,ind)
                    push!(j,ind1_u[i1_i])
                    push!(k,(1-δ)*pol_σ_U[i_i*n_a+a1_i,i1_i]*(1-p(θ[ind1_e[i1_i]])))
...
function GeneralEquilibrium(z)
    ...
    IL=0.13552810948945637-0.001 #0.2
    IU=0.13552810948945637+0.001 #0.35
    Ierr=1000
    ...
    while Ierr>ϵ
        ...
        EL=0.33789903408017574-0.001 # 0.05
        EU=min(0.33789903408017574+0.001,1/n_i-Id[1])  #min(1/n_i-Id[1],0.25)
        Eerr=1000
