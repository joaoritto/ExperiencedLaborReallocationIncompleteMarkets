...
function GeneralEquilibrium(z)
    ...
    IL=0.13718691980857714-0.001 #0.2
    IU=0.13718691980857714+0.001 #0.35
    Ierr=1000
    ...
    while Ierr>ϵ
        ...
        EL=0.33266331385175885-0.001 # 0.05
        EU=min(0.33266331385175885+0.001,1/n_i-Id[1])  #min(1/n_i-Id[1],0.25)
        Eerr=1000
