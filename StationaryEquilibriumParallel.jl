...
function GeneralEquilibrium(z)
    ...
    IL=0.09734815133453063-0.002 #0.2
    IU=0.09734815133453063+0.002 #0.35
    Ierr=1000
    ...
    while Ierr>ϵ
        ...
        EL=0.3718268695889341-0.002 # 0.05
        EU=min(0.3718268695889341+0.002,1/n_i-Id[1])  #min(1/n_i-Id[1],0.25)
        Eerr=1000
