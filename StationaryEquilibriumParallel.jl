...
function GeneralEquilibrium(z)
    ...
    IL=0.13580040549818614-0.001 #0.2
    IU=0.13580040549818614+0.001 #0.35
    Ierr=1000
    ...
    while Ierr>ϵ
        ...
        EL=0.33360935180796547-0.001 # 0.05
        EU=min(0.33360935180796547+0.001,1/n_i-Id[1])  #min(1/n_i-Id[1],0.25)
        Eerr=1000
